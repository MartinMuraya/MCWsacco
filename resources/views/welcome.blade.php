<x-layouts.app>
    ...
    <section class="services" style="background: white;">
        <div class="container">
            <div class="section-header" style="text-align: center; margin-bottom: 4rem;">
                <h2 style="font-size: 2.5rem; font-weight: 800;">Our Core <span>Services</span></h2>
            ...
            <div class="grid-cards" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 2.5rem;">
                <div class="card service-card" style="padding: 3rem 2rem; text-align: center; border: 1px solid var(--border); transition: var(--transition);">
                    <div class="service-icon" style="width: 70px; height: 70px; background: rgba(79, 70, 229, 0.1); color: var(--primary); border-radius: 20px; display: flex; align-items: center; justify-content: center; font-size: 2rem; margin: 0 auto 2rem auto;">
                        <i class="ph-fill ph-bank"></i>
                    </div>
                    <h3 style="margin-bottom: 1rem; font-size: 1.5rem;">Savings & Deposits</h3>
                ...
                <div class="card service-card" style="padding: 3rem 2rem; text-align: center; border: 1px solid var(--border); transition: var(--transition);">
                    ...
                    <h3 style="margin-bottom: 1rem; font-size: 1.5rem;">Affordable Loans</h3>
                ...
                <div class="card service-card" style="padding: 3rem 2rem; text-align: center; border: 1px solid var(--border); transition: var(--transition);">
                    ...
                    <h3 style="margin-bottom: 1rem; font-size: 1.5rem;">Student Hostels</h3>
    ...
    <section style="padding: 5rem 0; background: var(--primary); color: white;">
        <div class="container" style="text-align: center;">
            <h2 style="font-size: 2.5rem; font-weight: 800; margin-bottom: 1.5rem;">Join the Movement</h2>
            ...
            <a href="#" class="btn" style="background: white; color: var(--primary); font-size: 1.1rem; padding: 1rem 2.5rem;">Register Today</a>
        </div>
    </section>
</x-layouts.app>
